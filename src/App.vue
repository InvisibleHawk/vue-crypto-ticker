  ...
  methods: {
    subscribeToUpdates(tickerName) {
      setInterval(async () => {
        ...
        const f = await fetch(`https://min-api.cryptocompare.com/data/price?fsym=${tickerName}&tsyms=USD&api_key=c409232238d3508710a5599f4226424615c6dd491b874d3cdbf4755ece7348af`)
